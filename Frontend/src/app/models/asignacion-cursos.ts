export class AsignacionCursos {
    constructor( _id='', jornada='', curso='', nombre_curso='',  codigo_curso='',  instructor='', nombre_instructor='', instructor1=null, nombre_instructor1='', instructor2=null, nombre_instructor2=''){
        this._id = _id;
